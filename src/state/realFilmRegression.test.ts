...
function buildRecreationState(seed: number, spec: FilmRecreation, foundingCash: number, talent: TalentAssignment[]): GameState {
  ...
  return {
    ...
    studio: { ...result.studio, distributionArm: { tier: 3, internationalTier: 3 }, assets: [{ id: draft.assetId, script: draft.script!, provenance: 'Founding', acquisitionCost: 0, acquiredOnDay: 1 }] },
    screen: 'marketing',
