...
//   functions (engine/relationships.ts). Additive/optional (read defensively as
...
// v61 -> v62 added the Stunt Team roster (GameState.stuntTeamPool) and
//   FilmDraft.stuntTeamId - the Practical Effects facet's head
//   (docs/DESIGN_REVIEW_production_redesign.md §5.2).
// v62 -> v63 (§8 money split): ProductionChoices.contingencyAmount renamed to
...
// v66 -> v67 (Casting Redesign, Phase 6 - scheduling): FilmDraft gained an
//   optional plannedStartOffsetDays (the shoot-delay lever for waiting on a
//   booked actor). Additive/optional; key bumped per the same pre-launch policy.
...
// v76 -> v77 (Development & Financing, Phase 1): FilmDraft gained an optional
...
const SAVE_KEY = 'hollywood-pictures-save-v82';
