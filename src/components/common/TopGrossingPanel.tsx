...
export function TopGrossingPanel({ entries, playerStudioName, onSelectFilm }: TopGrossingPanelProps) {
  return (
            ...
            return (
              ...
              >
                ...
                <span className="top-grossing-details">
                  ...
                  <span className="top-grossing-studio">{entry.studioName} &middot; Week {entry.weekNumber}</span>
