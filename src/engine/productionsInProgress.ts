import type { FilmDraft, Talent, TalentRole } from '../types';
...
function advanceOne(d: FilmDraft, daysToAdvance: number, talentPool: Record<TalentRole, Talent[]>, rng: RandomFn): FilmDraft {
