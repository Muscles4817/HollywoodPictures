...
function freshFilm(id: string, releasedOnDay: number, fixed: AudienceSimulationFixedState, releasedBy?: string): Film {
  ...
  return {
    ...
    script: {
      id: 'script-1', title: 'Test Script', genre: RELEASE_INPUTS.genre, genreFit: 70, originality: RELEASE_INPUTS.scriptOriginality,
      structure: 60, dialogue: 60, marketability: RELEASE_INPUTS.scriptMarketability, complexity: 50, cost: 1_000_000,
